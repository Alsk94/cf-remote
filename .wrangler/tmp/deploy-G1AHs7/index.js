...
var require_dist = __commonJS({
  "../../../node_modules/@cloudflare/kv-asset-handler/dist/index.js"(exports) {
    ...
    var mapRequestToAsset2 = /* @__PURE__ */ __name((request, options) => {
  ...
  async fetch(request, env, ctx) {
    ...
    try {
      return await (0, import_kv_asset_handler.getAssetFromKV)(
        ...
        },
        {
          ...
          mapRequestToAsset: /* @__PURE__ */ __name((req) => {
            ...
            if (url2.pathname === "/") {
              return new Request(`${url2.origin}/index.html`, req);
            }
            return req;
          }, "mapRequestToAsset")
        }
      ...
      try {
        ...
        return new Response(`Error loading page: ${e2.message}`, {
          status: 404,
...
async function handleApiRequest(request, url, env) {
  ...
  if (url.pathname === "/api/oauth/token") {
    try {
      ...
      const accountId2 = accountsData.result[0]?.id;
      if (!accountId2) {
